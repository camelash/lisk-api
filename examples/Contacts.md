...
```
python pylisk contacts --key a69ed828f28695a03558d5c29f96081d20d1ecc0e046e8622793ab2662629901
```
...
```
python pylisk unconfirmed_contacts --key a6ed31b0dce156779b77f8e1c723af0ce04dbb74520979b76866da56ede4462f
```
...
```
python pylisk add_contact --username slasheks_api
Password: 
